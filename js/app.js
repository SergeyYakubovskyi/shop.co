(() => {
    ...
    function rangeInit() {
        ...
        if (priceSlider) {
            ...
            function updateValuePosition() {
                ...
                const handle1Rect = handles[0].getBoundingClientRect();
                const handle2Rect = handles[1].getBoundingClientRect();
                const sliderRect = priceSlider.getBoundingClientRect();
                priceStart.style.left = `${handle1Rect.left - sliderRect.left + handle1Rect.width / 2}px`;
                let handle2Position = handle2Rect.left - sliderRect.left + handle2Rect.width / 2;
                if (handle2Position > sliderRect.width - handle2Rect.width / 2) handle2Position = sliderRect.width - handle2Rect.width / 2;
                priceEnd.style.left = `${handle2Position}px`;
            }
    ...
    function initSliders() {
        if (document.querySelector(".product-item__slider")) new swiper_core_Swiper(".product-item__slider", {
            modules: [ Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
*/    var Observer_gsap, Observer_coreInitted, Observer_win, Observer_doc, _docEl, _body, _isTouch, _pointerType, ScrollTrigger, _root, _normalizer, _eventTypes, Observer_context, _getGSAP = function _getGSAP() {
    ...
    Observer_Observer.version = "3.12.4";
...
*/
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const removeBtn = document.querySelector(".top-header__remove-btn");
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const toggleButton = document.querySelector(".action-header__button");
        const searchBlock = document.querySelector(".menu__search.search");
        toggleButton.addEventListener("click", (function() {
            searchBlock.classList.toggle("show-input");
        }));
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        document.querySelectorAll(".inner-content").forEach((section => {
            const showMore = section.querySelector(".inner-content__btn-show");
            const productContainer = section.querySelector(".inner-content__products");
            const products = productContainer.querySelectorAll(".inner-content__cards");
            let items = 1;
            products.forEach(((el, index) => {
                if (index < items) el.classList.add("is-visible");
            }));
            showMore.addEventListener("click", (() => {
                items += 3;
                const visItems = Array.from(products).slice(0, items);
                visItems.forEach((el => el.classList.add("is-visible")));
                if (visItems.length >= products.length) showMore.style.display = "none";
            }));
        }));
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        const decreaseBtns = document.querySelectorAll(".quantity__btn--decrease");
        const increaseBtns = document.querySelectorAll(".quantity__btn--increase");
        const quantityInputs = document.querySelectorAll(".quantity__input");
        const addToCartBtns = document.querySelectorAll(".action-item__btn");
        const deleteBtns = document.querySelectorAll(".inner-content__delete");
        document.querySelector(".your-cart__items");
        document.querySelector(".your-cart__order-sum");
        const cartWrapper = document.querySelector(".your-cart__wrapper");
        const cartContent = document.querySelector(".your-cart__content");
        const subtotalElem = document.querySelector(".order-sum__value");
        const totalElem = document.querySelector(".order-sum__total .order-sum__value");
        const discountElem = document.querySelector(".order-sum__value--dis");
        const deliveryFeeElem = document.querySelector(".order-sum__item:nth-child(3) .order-sum__value");
        const cartCountElem = document.querySelector(".icon-cart span");
        let cartCount = 0;
        ...
        function updateOrderSummary() {
            if (!subtotalElem || !totalElem || !discountElem || !deliveryFeeElem) return;
            let subtotal = 0;
            const prices = document.querySelectorAll(".inner-content__price");
            prices.forEach((priceElem => {
                const price = parseFloat(priceElem.textContent.replace("$", ""));
                const quantity = parseInt(priceElem.closest(".inner-content").querySelector(".quantity__input").value);
        ...
        deleteBtns.forEach((deleteBtn => {
            deleteBtn.addEventListener("click", (function() {
                const block = deleteBtn.closest(".cart-block__body");
                if (block) {
                    block.remove();
                    updateOrderSummary();
                    const remainingBlocks = document.querySelectorAll(".cart-block__body");
                    if (remainingBlocks.length === 0) {
                        cartContent.style.display = "none";
                        if (!document.querySelector(".empty-cart-message")) cartWrapper.appendChild(emptyCartMessage);
                    }
                }
            }));
        }));
        ...
        const openButton = document.querySelector(".sort__filter");
        const closeButton = document.querySelector(".top__action");
        if (sidebar && openButton && closeButton) {
            openButton.addEventListener("click", (() => {
                if (sidebar.style.left === "0px") sidebar.style.left = "-100%"; else sidebar.style.left = "0";
            }));
            closeButton.addEventListener("click", (() => {
                sidebar.style.left = "-100%";
            }));
            document.addEventListener("click", (e => {
                if (!sidebar.contains(e.target) && !openButton.contains(e.target)) sidebar.style.left = "-100%";
            }));
        }
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (!logoContainer) {
            console.error("Logo container not found in the DOM.");
            return;
        }
        const logoLink = logoContainer.querySelector("a.header__logo");
        const logoText = logoLink ? logoLink.querySelector("span") : null;
        if (!logoText) {
            console.error("Logo text not found in the DOM.");
            return;
        }
        if (isHomePage) {
            logoLink.removeAttribute("href");
            logoLink.classList.remove("header__logo");
            logoText.classList.add("header__logo");
        } else if (!logoLink) {
            const newLogoLink = document.createElement("a");
            newLogoLink.href = "home.html";
            newLogoLink.classList.add("header__logo");
            newLogoLink.appendChild(logoText);
            logoContainer.innerHTML = "";
            logoContainer.appendChild(newLogoLink);
        } else if (!logoLink.hasAttribute("href")) logoLink.setAttribute("href", "home.html");
    }));
    if (document.querySelector(".hero__title")) gsapWithCSS.from(".hero__title", {
        scrollTrigger: {
            trigger: ".hero__title",
            start: "top 80%",
            once: true
    ...
    if (document.querySelector(".hero__text")) gsapWithCSS.from(".hero__text", {
        scrollTrigger: {
            trigger: ".hero__text",
            start: "top 80%",
            once: true
    ...
    if (document.querySelector(".hero__btn")) gsapWithCSS.from(".hero__btn", {
        scrollTrigger: {
            trigger: ".hero__btn",
            start: "top 80%",
            once: true
    ...
    if (document.querySelectorAll(".achivment__item").length) gsapWithCSS.from(".achivment__item", {
        scrollTrigger: {
            trigger: ".achivment__item",
            start: "top 80%",
            once: true
        },
        y: 50,
    ...
    if (document.querySelector(".hero__image img")) gsapWithCSS.from(".hero__image img", {
        scrollTrigger: {
            trigger: ".hero__image",
            start: "top 80%",
            once: true
    ...
    if (document.querySelectorAll(".hero__decor").length) gsapWithCSS.from(".hero__decor", {
        scrollTrigger: {
            trigger: ".hero__decor",
            start: "top 80%",
            once: true
    ...
    if (document.querySelectorAll(".brand__logo").length) gsapWithCSS.from(".brand__logo", {
        scrollTrigger: {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const titles = document.querySelectorAll(".inner-content__title");
        ...
        })); else console.log("Заголовки не знайдено");
        const cards = document.querySelectorAll(".card-item__body");
        if (cards.length) gsapWithCSS.from(cards, {
            scrollTrigger: {
                trigger: cards[0],
                start: "top 75%",
                once: true
            ...
            ease: "power2.out",
            stagger: .2
        }); else console.log("Картки товарів не знайдено");
        const viewAllButtons = document.querySelectorAll(".inner-content__btn-show");
        if (viewAllButtons.length) viewAllButtons.forEach((button => {
        ...
        })); else console.log("Кнопки 'View All' не знайдено");
        const styleTitle = document.querySelector(".style__title");
        if (styleTitle) gsapWithCSS.from(styleTitle, {
            scrollTrigger: {
                trigger: styleTitle,
                start: "top 85%",
                once: true
            ...
            duration: 1,
            ease: "power2.out"
        }); else console.log("Заголовок стилів не знайдено");
        const styleBlocks = document.querySelectorAll(".style-block__body");
        if (styleBlocks.length) gsapWithCSS.from(styleBlocks, {
            scrollTrigger: {
                trigger: styleBlocks[0],
                start: "top 85%",
                once: true
            },
            opacity: 0,
            ...
            ease: "power2.out",
            stagger: .2
        }); else console.log("Блоки стилів не знайдено");
    }));
    window.onload = function() {
        gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
        const feedbackTitle = document.querySelector(".feedback__title");
        if (feedbackTitle) gsapWithCSS.from(feedbackTitle, {
            scrollTrigger: {
                trigger: feedbackTitle,
                start: "top 80%",
                once: true
            },
            opacity: 0,
        ...
        if (feedbackSlides.length) gsapWithCSS.from(feedbackSlides, {
            scrollTrigger: {
                trigger: feedbackSlides[0],
                start: "top 80%",
                once: true
            },
            opacity: 0,
        ...
        const feedbackArrows = document.querySelectorAll(".feedback__arrows button");
        if (feedbackArrows.length) gsapWithCSS.from(feedbackArrows, {
            scrollTrigger: {
                trigger: ".feedback__arrows",
                start: "top 85%",
                once: true
            },
            opacity: 0,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
        const productSection = document.querySelector(".product-item__container");
        if (productSection) gsapWithCSS.from(productSection, {
            scrollTrigger: {
        ...
        const productTitle = document.querySelector(".dtl-info__title");
        if (productTitle) gsapWithCSS.from(productTitle, {
            scrollTrigger: {
        ...
        const productThumbs = document.querySelectorAll(".swiper-thumbs__slide");
        if (productThumbs.length) gsapWithCSS.from(productThumbs, {
            scrollTrigger: {
                trigger: productThumbs[0],
                start: "top 85%",
                once: true
            },
            opacity: 0,
        ...
        const productImages = document.querySelectorAll(".product-item__slide");
        if (productImages.length) gsapWithCSS.from(productImages, {
            scrollTrigger: {
                trigger: productImages[0],
                start: "top 80%",
                once: true
            },
            opacity: 0,
        ...
        const productRating = document.querySelector(".dtl-info__rating");
        if (productRating) gsapWithCSS.from(productRating, {
            scrollTrigger: {
                trigger: productRating,
                start: "top 80%",
                once: true
            },
            opacity: 0,
        ...
        const colorOptions = document.querySelectorAll(".options__item");
        if (colorOptions.length) gsapWithCSS.from(colorOptions, {
            scrollTrigger: {
                trigger: colorOptions[0],
                start: "top 85%",
                once: true
            },
            opacity: 0,
        ...
        const sizeOptions = document.querySelectorAll(".size-button");
        if (sizeOptions.length) gsapWithCSS.from(sizeOptions, {
            scrollTrigger: {
                trigger: sizeOptions[0],
                start: "top 85%",
                once: true
            },
            opacity: 0,
        ...
        const quantityControl = document.querySelector(".action-item__quantity");
        if (quantityControl) gsapWithCSS.from(quantityControl, {
            scrollTrigger: {
                trigger: quantityControl,
                start: "top 80%",
                once: true
            },
            opacity: 0,
        ...
        const actionButton = document.querySelector(".action-item__btn");
        if (actionButton) {
            gsapWithCSS.from(actionButton, {
                scrollTrigger: {
            ...
            const quantityControl = document.querySelector(".offer__title");
            if (quantityControl) gsapWithCSS.from(quantityControl, {
                scrollTrigger: {
                    trigger: quantityControl,
                    start: "top 80%",
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
        const sidebarFilters = document.querySelector(".category-block__sidebar");
        if (sidebarFilters) gsapWithCSS.from(sidebarFilters, {
            scrollTrigger: {
                trigger: sidebarFilters,
                start: "top 90%",
                once: true
            },
            opacity: 0,
        ...
        const productTitle = document.querySelector(".sort__title");
        if (productTitle) gsapWithCSS.from(productTitle, {
            scrollTrigger: {
                trigger: productTitle,
                start: "top 90%",
        ...
        const priceFilter = document.querySelector(".price-tool");
        if (priceFilter) gsapWithCSS.from(priceFilter, {
            scrollTrigger: {
                trigger: priceFilter,
                start: "top 85%",
                once: true
        ...
        const applyFilterButton = document.querySelector(".sidebar__btn");
        if (applyFilterButton) gsapWithCSS.from(applyFilterButton, {
            scrollTrigger: {
                trigger: applyFilterButton,
                start: "top 85%",
                once: true
            },
            opacity: 0,
        ...
        const pagination = document.querySelector(".main-product__pagination");
        if (pagination) gsapWithCSS.from(pagination, {
            scrollTrigger: {
                trigger: pagination,
                start: "top 90%",
                once: true
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger);
        const cartTitle = document.querySelector(".your-cart__title");
        if (cartTitle) gsapWithCSS.from(cartTitle, {
            scrollTrigger: {
                trigger: cartTitle,
                start: "top 90%",
                once: true
        ...
        const cartItems = document.querySelectorAll(".cart-block__body");
        if (cartItems.length) gsapWithCSS.from(cartItems, {
            scrollTrigger: {
                trigger: cartItems[0],
                start: "top 85%",
                once: true
        ...
        const quantityButtons = document.querySelectorAll(".quantity__btn");
        if (quantityButtons.length) gsapWithCSS.from(quantityButtons, {
            scrollTrigger: {
                trigger: quantityButtons[0],
                start: "top 85%",
                once: true
            },
            opacity: 0,
        ...
        const orderSummary = document.querySelector(".order-sum");
        if (orderSummary) gsapWithCSS.from(orderSummary, {
            scrollTrigger: {
        ...
        const checkoutButton = document.querySelector(".order-sum__button");
        if (checkoutButton) gsapWithCSS.from(checkoutButton, {
            scrollTrigger: {
        ...
        const promoCodeForm = document.querySelector(".promo");
        if (promoCodeForm) gsapWithCSS.from(promoCodeForm, {
            scrollTrigger: {
                trigger: promoCodeForm,
                start: "top 85%",
                once: true
            },
            opacity: 0,
        ...
        const deleteButtons = document.querySelectorAll(".inner-content__delete");
        if (deleteButtons.length) gsapWithCSS.from(deleteButtons, {
            scrollTrigger: {
                trigger: deleteButtons[0],
                start: "top 85%",
                once: true
            },
            opacity: 0,
